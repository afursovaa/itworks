...
№5
  1) создать цикл, который выполняет действия с натуральными числами
  2) выполнить указанные в задании действия с числами
  3) выйти из цикла, если число подходиться под данные условия, печатая это число
